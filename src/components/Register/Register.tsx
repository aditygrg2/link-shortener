...
const Register: React.FC = () => {
    ...
    return (
        <>
            {isLoginOpen && <div onClick={() => dispatch(toggleLogin())} className={`h-full hidden lg:block w-full absolute z-[80] backdrop-blur-xl`}></div>}
            {
                <div
                    ...
                    <div className="absolute h-full w-full bg-gradient-to-b from-black/80 via-black/40 to-black/20">
                        ...
                        {
                            <div className={`absolute h-full bg-gradient-to-r from-[#131E25] via-[#131E25]/50 to-[#131E25]/5 ${loading ? 'w-full' : 'w-0'} transition-all duration-400 top-0 left-0 z-[110] backdrop-blur-md`}></div>
                        }
